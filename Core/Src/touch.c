...
void touch_Adjust(void)
{
	...
	double fac;
 	...
 	lcd_show_string(5,40,"Please adjust the screen",RED,WHITE,16,0);
 	lcd_show_string(5,65,"by touching the marked",RED,WHITE,16,0);
 	lcd_show_string(5,90,"points one by one",RED,WHITE,16,0);
				...
				case 4:
					...
					if(fac<0.95||fac>1.05||d1==0||d2==0)
					{
 				    ...
 				    TP_Drow_Touch_Point(lcddev.width-20,lcddev.height-20,WHITE);
   	 				TP_Drow_Touch_Point(20,20,RED);
						lcd_show_string(5,40,"Touch Adjust Failed!          ",RED,WHITE,16,0);
						lcd_show_string(5,60,"Please Adjust Again!         ",RED,WHITE,16,0);
						HAL_Delay(1000);
 						continue;
					}
					...
					TP_Drow_Touch_Point(lcddev.width-20,lcddev.height-20,WHITE);
					lcd_show_string(5,40,"Touch Screen Adjust OK!      ",RED,WHITE,16,0);
					lcd_show_string(5,60,"                             ",RED,WHITE,16,0);
					HAL_Delay(1000);
 					lcd_show_string(5,40,"                       ",RED,WHITE,16,0);
					TP_Save_Adjdata();
					TP_Get_Adjdata();
					return;
			}
